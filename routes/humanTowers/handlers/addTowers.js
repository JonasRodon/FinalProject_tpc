...
module.exports = (req, res) => {
  ...
  const { tags } = req.body
  const tower = new HumanTowers({ title, category, path, comunity, localitation, startDate, timeHourStart, timeMinuteStart, endDate, timeHourEnd, timeMinuteEnd, description, tags })
